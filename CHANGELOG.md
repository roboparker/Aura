...
The format is based on [Keep a Changelog](https://keepachangelog.com/), and this project uses [date-based build numbers](docs/developer/branching-and-releases.md) for versioning (`YYYY.MM.DD.N`).
