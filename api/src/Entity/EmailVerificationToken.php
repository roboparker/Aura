...
/**
 * A single-use, time-boxed email-confirmation token. Mirrors
 * {@see PasswordResetToken}: only the sha256 hash is stored, so a database
 * read can't reconstruct the link that was emailed.
 */
#[ORM\Entity(repositoryClass: EmailVerificationTokenRepository::class)]
#[ORM\Table(name: 'email_verification_token')]
#[ORM\Index(columns: ['token_hash'], name: 'idx_email_verification_token_hash')]
