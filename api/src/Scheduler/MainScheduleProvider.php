    ...
    public function getSchedule(): Schedule
    {
        ...
        return (new Schedule())
            ->with(
                ...
                // Deletion purge: hard-delete organizations, spaces, and
                // accounts whose 30-day grace period has lapsed, and sweep
                // spent restore tokens (App\Deletion\PurgeRunner). 04:20 keeps
                // it clear of the backup and the export prunes; running it
                // daily means a delete lands within a day of the date the owner
                // was shown — never before it.
                RecurringMessage::cron('20 4 * * *', new PurgeDeletedRecords(), $utc),
            )
            ->stateful($this->cache)
