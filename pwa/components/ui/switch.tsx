...
/**
 * Toggle switch built on the base-ui Switch primitive (same library the
 * Combobox uses). Controlled via `checked` / `onCheckedChange`, styled
 * with our design tokens so it reads as part of the shadcn set.
 */
function Switch({
  className,
  ...props
