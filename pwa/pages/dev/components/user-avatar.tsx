...
const UserAvatarPage = () => (
  <ComponentDoc
    name="UserAvatar"
    description="Renders the uploaded image when present, otherwise white initials on the user's `personalizedColor` (a contrast-safe palette picked at signup). Always a rounded square; the corner radius scales with size. Sizes: sm (32px), md (40px), lg (96px)."
